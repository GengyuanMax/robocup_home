...
(cl:defmethod theta-val ((m <DesiredPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_vis-msg:theta-val is deprecated.  Use turtle_vis-msg:theta instead.")
  (theta m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DesiredPose>)))
  ...
  (cl:format cl:nil "#>>>>TODO: DEFINE 3 FLOATS NAMED: x, y, and theta FOR THIS MSG~%float64 x~%float64 y~%float64 theta~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DesiredPose)))
  "Returns full string definition for message of type 'DesiredPose"
  (cl:format cl:nil "#>>>>TODO: DEFINE 3 FLOATS NAMED: x, y, and theta FOR THIS MSG~%float64 x~%float64 y~%float64 theta~%~%~%"))
