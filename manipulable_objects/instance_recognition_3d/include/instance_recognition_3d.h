/*
 * instance_recognition_3d.h
 *
 *  Created on: 07-2019
 *      Author: luz.martinez@tum.de
 */

#ifndef INSTANCERECOGNITION3D_H_
#define INSTANCERECOGNITION3D_H_
...
public:
	...
	InstanceRecognition3D(std::string name);
	virtual ~InstanceRecognition3D();
...
private:
	...
	PFPFH::Ptr descriptor_fpfh(PointCloud::Ptr cloud_in, PNormal::Ptr cloud_normals);
	 bool matching(PVFH dscr_in) ;
};

} /* namespace  */
#endif /* INSTANCERECOGNITION3D_H_ */
